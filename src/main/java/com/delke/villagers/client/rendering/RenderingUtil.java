...
public class RenderingUtil {
    ...
    public static void renderBoundingBox(PoseStack stack, BoundingBox box) {
        ...
        double maxH = box.maxY() - vec3.y();
        double minX = box.minX() - vec3.x();
        double minZ = box.minZ() - vec3.z();
        double maxX = box.maxX() - vec3.x();
        double maxZ = box.maxZ() - vec3.z();
    ...
    public static void renderHitOutline(PoseStack stack, VertexConsumer vertexConsumer, Entity entity, double p_109641_, double p_109642_, double p_109643_, BlockPos p_109644_, BlockState p_109645_) {
        ...
        if (level != null) {
            renderShape(stack, vertexConsumer, p_109645_.getShape(level, p_109644_, CollisionContext.of(entity)), (double)p_109644_.getX() - p_109641_, (double)p_109644_.getY() - p_109642_, (double)p_109644_.getZ() - p_109643_, 1.0F, 0.0F, 0.0F, 0.0F);
        }
    }


    private static void renderShape(PoseStack stack, VertexConsumer vertexConsumer, VoxelShape shape, double p_109786_, double p_109787_, double p_109788_, float p_109789_, float p_109790_, float p_109791_, float p_109792_) {
